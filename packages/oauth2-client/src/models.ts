...
import { PrismaClient as client, OAuthClient, OAuthUser } from '../dist/generated/prisma'
...
export const isExpiredDate = (expires: Dayjs) => {
  const now = dayjs().valueOf();
  const expiredDate = expires.valueOf();
